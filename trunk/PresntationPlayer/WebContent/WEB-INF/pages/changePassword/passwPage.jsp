...
<template:insert template='/WEB-INF/pages/template/template.jsp'>
	...
	<template:put name='extraIncludes' content='/WEB-INF/pages/changePassword/passwIncludes.jsp' />
	<template:put name='content' content='/WEB-INF/pages/changePassword/passwContent.jsp' />
</template:insert>