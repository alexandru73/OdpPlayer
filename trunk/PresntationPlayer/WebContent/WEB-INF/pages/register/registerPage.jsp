...
<template:insert template='/WEB-INF/pages/template/template.jsp'>
	...
	<template:put name='extraIncludes' content='/WEB-INF/pages/register/registerIncludes.jsp' />
	<template:put name='content' content='/WEB-INF/pages/register/registerContent.jsp' />
</template:insert>