...
<template:insert template='/WEB-INF/pages/template/template.jsp'>
	...
	<template:put name='content' content='/WEB-INF/pages/player/playerContent.jsp' />
	<template:put name='extraIncludes' content='/WEB-INF/pages/player/playerIncludes.jsp' />
</template:insert>