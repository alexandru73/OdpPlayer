...
public class PutTag extends TagSupport {
	...
	public int doStartTag() throws JspException {
		InsertTag parent = (InsertTag) getAncestor("com.school.tags.templates.InsertTag");
		if (parent == null)
		...
		Hashtable<String, PageParameter> params = (Hashtable<String, PageParameter>) template_stack.peek();
